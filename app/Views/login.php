...
<head>
  ...
  <title>Login &mdash; WEB AGENDA</title>
    ...
    <section class="section">
      <div class="container mt-5">
        <div class="row">
          ...
          <div class="login-brand d-flex align-items-center">
            <img src="<?=base_url()?>/template-stisla/assets/img/logo_bp_batam.jpeg" alt="image" width="100" class="shadow-light mr-3">
            <h4 class="mt-2">SELAMAT DATANG DI WEB AGENDA</h4>
            </div>
